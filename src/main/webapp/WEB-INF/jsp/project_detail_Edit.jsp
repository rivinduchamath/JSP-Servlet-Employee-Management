                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="message_wrapper">
                                                            ...
                                                            <blockquote class="message">Raw denim you probably haven't
                                                                heard of
                                                                them jean shorts Austin. Nesciunt tofu stumptown aliqua
                                                                butcher
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="text-center mtop20">
                                                        ...
                                                        <a href="/project_ds?projectId=${1}" class="btn btn-sm btn-primary">Add Activity</a>
                    ...
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="Dashboard" class="site_title"> <img
                                    style="margin-top: -0px; width: 40px;height: 40px"
                                    src="../../images/favicon.ico"><span
                                    style="margin-top: 20px;">&nbsp;Four</span></a>
                        </div>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="text-center mtop20">
                                                        ...
                                                        <a href="/project_detail?projectId=${1}"class="btn btn-sm btn-primary">Add asActivity</a>
