                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3  profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img style="width: 100px;height: 100px" class="img-responsive avatar-view" src="../../images/icons/${loggerName.pic}" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3>${loggerName.name}</h3>

                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> ${loggerName.address}
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> ${loggerName.occupation}
                        </li>

                        <li class="m-top-xs">
                          <i class="fa fa-external-link user-profile-icon"></i>
                          <a href= "https://+${loggerName.email}" target="_blank">${loggerName.email}</a>
                        </li>
                      </ul>
